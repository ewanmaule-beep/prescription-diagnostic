...
export default function DiagnosticPage() {
  ...
  function isAnswered() {
    ...
    if (current.type === "text") return true; // text is never required
  ...
  function handleNext() {
    ...
    setError(null);
    if (isLast) {
      // Store answers in sessionStorage so the report page can read them
  ...
  return (
    <Layout maxWidth="md">
      ...
      {/* Skip hint for non-required text questions */}
      {current.type === "text" && (
